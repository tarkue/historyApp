...
const persons = [
    ...
    },
    {
        ...
        img: "/чел2.png",
        text: "(1899-1953) -советский политический деятель и глава НКВД, сыграл важную роль во время Второй мировой войны и послевоенного периода при создании первой атомной бомбы.",
        tag: tags.USSR,
    },
    {
