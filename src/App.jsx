...
В рамках проекта были созданы 3 атомные бомбы: плутониевая «Штучка» (Gadget) – взорвана при первом ядерном испытании, урановый «Малыш» (Little Boy) – сброшена на Хиросиму 6 августа 1945 г., и плутониевый «Толстяк» (Fat Man) – сброшена на Нагасаки 9 августа 1945 г.<br/>
    ...
    <div className={s.ChronologyWrapper}>
      ...
      <div className={s.flexim}>
        ...
        <ChronologyItem text='5. Начальник—Павел Зернов, главный конструктор—Юлий Харитон. Сверхсекретный объект был в 80 км от Арзамаса на территории бывшего Саровского монастыря. ' photo='/ссср5.png' podpis='Сверхсекретный объект на территории Саратовского монастыря'/>
        ...
        <ChronologyItem text='7. К январю 1949 отработан весь комплекс конструкторских вопросов по РДС 1 (первая атомная бомба). В 170 км от города Семипалатинска был построен испытательный комплекс Учебный полигон № 2 Министерства обороны СССР. В мае 1949 года на полигон прибыл Курчатов, он руководил испытаниями.' photo='/ссср7.png' podpis='РДС 1-первая атомная бомба'/>
